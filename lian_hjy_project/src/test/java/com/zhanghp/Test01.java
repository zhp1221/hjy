...
public class Test01 {
    ...
    public void testGenerator() {
        ...
        globalConfig.setAuthor("zhanghp")
                .setOutputDir("D:\\12\\IDea_WorkSpace\\lian_hjy_project\\src\\main\\java")//设置输出路径
        ...
        dataSourceConfig.setDriverName("com.mysql.cj.jdbc.Driver").setUrl("jdbc:mysql://localhost:3306/hjy?serverTimezone=UTC")
        ...
        packageConfig.setParent("com.zhanghp").setMapper("mapper")
